...
var details = function () {
  return {
    name: 'Extract DoVi 7 (Dual > Single-Layer)',
    description: 'Extract Dolby Vision RPU data for Profile 7, converting from dual layer to single layer',
...
var plugin = function (args) {
  return __awaiter(void 0, void 0, void 0, function () {
    var lib, pluginWorkDir, outputFileName, outputFilePath, videoStreamCount, ffprobeCmd, probeRes, fs, outputStat, ffmpegCmd, spawnArgs, cli, res;
