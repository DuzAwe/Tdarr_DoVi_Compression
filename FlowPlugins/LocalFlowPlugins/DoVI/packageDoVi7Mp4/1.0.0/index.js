...
/*
  MP4Box requires a compatibility mode for DV profile 8.
  We'll add `:dvp=8.1:dv-cm=hdr10` to satisfy the requirement.
*/

var details = function () {
  return {
    name: 'Package DoVi 7 mp4',
    description: 'Package HEVC stream with injected DoVi RPU in mp4 (Profile 8)',
