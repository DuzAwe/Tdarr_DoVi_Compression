    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          // Profile 5 (display-managed, no HDR10 fallback) when source lacks fallback; otherwise P8.1
          const dvProfile = fallbackMissing ? '5' : '8.1';
          mp4Args = `${args.inputFileObj.file}:${fps}:timescale=${timescale}:dvp=${dvProfile}`;
